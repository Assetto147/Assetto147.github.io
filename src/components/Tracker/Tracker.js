        ...
        return(
            <div className="trackerBlock">
                <div className="welcome">
                    <span>Witaj, {currentUser.displayName}!</span>
                    <button className="exit" onClick={this.logout}>Wyloguj</button>
                </div>
                <div className="totalMoney">PLN {this.state.money}</div>
                ...
                <div className="newTransactionBlock">
                    <div className="newTransaction">
                        <form>
                            ...
                            <div className="inputGroup">
                                <select name="type"
                                    ...
                                    <option value="deposit">Przychód</option>
                                </select>
                                <input
                        ...
                        <button onClick={() => this.addNewTransaction()} className="addTransaction"> Dodaj </button>
                    </div>
                </div>
